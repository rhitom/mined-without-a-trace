...
| `/diagram/[phone]` | Interactive component diagram with SVG-aligned callout labels |
...
- `components.svg` includes the hand-drawn callout lines used to place the vertically aligned right-side label column on `/diagram/[phone]`
...
- [x] Component diagram (`/diagram/[phone]`) - enlarged centered exploded-view SVG with vertically aligned hover labels
...
| `public/illustrations/components.svg` | `/diagram/iphone` | Exploded view with hand-drawn callout lines and right-side label column |
...
- **Component diagram (`/diagram/iphone`):** Exploded-view `components.svg` enlarged and centered in the page. A vertically aligned right-side label column is positioned from the hand-drawn callout line endpoints, and each label fills cranberry on hover instead of using hotspot overlays or a side panel.
